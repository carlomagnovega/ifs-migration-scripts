		   ...
		   LOOP
			   ...
			   LOOP
	            ...
	            Xml_Record_Writer_SYS.Add_Element(xml$_, 'FREIGHT_PREV', rec_customer_detail_.freight_prev);
			      ...
			      Xml_Record_Writer_SYS.Add_Element(xml$_, 'GP_PREV', rec_customer_detail_.amount_prev - rec_customer_detail_.cost_prev - rec_customer_detail_.freight_prev);
			      Xml_Record_Writer_SYS.Add_Element(xml$_, 'GP_CURRENT', rec_customer_detail_.amount_current - rec_customer_detail_.cost_current - rec_customer_detail_.freight_current);
			      Xml_Record_Writer_SYS.Add_Element(xml$_, 'GP_MONTH', rec_customer_detail_.amount_month - rec_customer_detail_.cost_month - rec_customer_detail_.freight_month);
			      Xml_Record_Writer_SYS.Add_Element(xml$_, 'GP_MONTH_PREV', rec_customer_detail_.amount_month_prev - rec_customer_detail_.cost_month_prev - rec_customer_detail_.freight_month_prev);
	
			      Xml_Record_Writer_SYS.Add_Element(xml$_, 'GP_PRC_PREV', (rec_customer_detail_.amount_prev - rec_customer_detail_.cost_prev - rec_customer_detail_.freight_prev)*100/CASE WHEN rec_customer_detail_.amount_prev = 0 THEN 1 ELSE rec_customer_detail_.amount_prev END);
			      Xml_Record_Writer_SYS.Add_Element(xml$_, 'GP_PRC_CURRENT', (rec_customer_detail_.amount_current - rec_customer_detail_.cost_current - rec_customer_detail_.freight_current)*100/CASE WHEN rec_customer_detail_.amount_current = 0 THEN 1 ELSE rec_customer_detail_.amount_current END);
			      Xml_Record_Writer_SYS.Add_Element(xml$_, 'GP_PRC_MONTH', (rec_customer_detail_.amount_month - rec_customer_detail_.cost_month - rec_customer_detail_.freight_month)*100/CASE WHEN rec_customer_detail_.amount_month = 0 THEN 1 ELSE rec_customer_detail_.amount_month END);
			      Xml_Record_Writer_SYS.Add_Element(xml$_, 'GP_PRC_MONTH_PREV', (rec_customer_detail_.amount_month_prev - rec_customer_detail_.cost_month_prev - rec_customer_detail_.freight_month_prev)*100/CASE WHEN rec_customer_detail_.amount_month_prev = 0 THEN 1 ELSE rec_customer_detail_.amount_month_prev END);
